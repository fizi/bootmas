...
/* ---------------------------------------------------------------------------------------------------------------------------*/
    $MENU_TEMPLATE['home-service']['start'] = '
    <!-- start home-service -->
    <div class="home-service {CMENUNAME}">
    ';
    
	$MENU_TEMPLATE['home-service']['body'] = '
      <div class="mb-2">{CMENUBODY}</div>
      <div class="home-service-button text-center">{CPAGEBUTTON: class=btn btn-warning btn-sm}</div>
    ';
    
	$MENU_TEMPLATE['home-service']['end'] = '
    </div>
    <!-- end home-service -->
    ';
