...
$NEXTPREV_TEMPLATE['bootstrap_nav_prev'] = '
    <a class="prev page-numbers" href="{url}" title="{url_label}"><i class="fas fa-angle-left"></i></a>';
$NEXTPREV_TEMPLATE['bootstrap_nav_last'] = '';
$NEXTPREV_TEMPLATE['bootstrap_nav_next'] = '
    <a class="next page-numbers" href="{url}" title="{url_label}"><i class="fas fa-angle-right"></i></a>';

$NEXTPREV_TEMPLATE['bootstrap_items_start'] = '';
$NEXTPREV_TEMPLATE['bootstrap_item'] = '
    <a class="page-numbers" href="{url}" title="{url_label}">{label}</a></li>';
